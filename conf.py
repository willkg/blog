...
BLOG_AUTHOR = "Will Kahn-Greene"
BLOG_TITLE = "Will's Blog"
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bluesock.org/~willkg/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "willkg@bluesock.org"
BLOG_DESCRIPTION = (
    "Will Kahn-Greene's blog of Python, Mozilla, random content, "
    "personal projects, work projects, and other things mixed "
    "in there ad hoc, half-baked, and with a twist of lemon"
)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("https://bluesock.org/~willkg/", "Home"),
...
# bootblog4 supports:
#     featured_large featured_small featured_on_mobile
#     featured_large_image_on_mobile featured_strip_html sidebar
# bootstrap4 supports:
#     navbar_light (defaults to False)
THEME_CONFIG = {
    DEFAULT_LANG: {
...
# DATE_FORMAT = "EEEE MMMM d, YYYY HH:mm"
...
# repository.
# EXTRA_THEMES_DIRS = []
EXTRA_THEMES_DIRS = [str((pathlib.Path('.') / 'themes').resolve())]
...
def is_old(dt):
    """Returns True if this blog post is older than 5 years"""
    now = datetime.datetime.now(datetime.timezone.utc)
    return (now - dt) > datetime.timedelta(days=365 * 5)
...
EMAILCOMMENTS_TEXT = (
    ...
    'some context as to what you are talking about.'
    '</section>'
)
